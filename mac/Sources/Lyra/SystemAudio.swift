...
final class SystemAudioMonitor: @unchecked Sendable {
    ...
    private let log = Logger(subsystem: "local.lyra", category: "audio")
    ...
    private let queue = DispatchQueue(label: "local.lyra.system-audio")
    ...
    func start() {
        ...
        do {
            ...
            description.name = "Lyra visualiser"
            ...
            let aggregate: [String: Any] = [
                kAudioAggregateDeviceNameKey: "Lyra visualiser",
