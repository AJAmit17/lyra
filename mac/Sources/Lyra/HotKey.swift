...
final class HotKey {
    ...
    private static let signature: OSType = 0x4A657644 // LyraD
...
private struct HotKeyError: LocalizedError {
    ...
    var errorDescription: String? {
        if code == OSStatus(eventHotKeyExistsErr) {
            return "Control–Option–Space is already registered by another app. Free that shortcut, then restart Lyra."
        }
