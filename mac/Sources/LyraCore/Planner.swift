...
/// One planned step in a closed vocabulary. Code executes the deterministic kinds; Lyra grounds the on-screen ones.
public struct PlanStep: Codable, Equatable {
    ...
    /// Short description shown in the widget and given to Lyra as the step.
